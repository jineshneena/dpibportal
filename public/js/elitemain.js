...
POLICY.COMMISSIONSPLIT.recalcSplit = function () {
    ...
    var total_commission = parseFloat($("#broker_commission").val()).toFixed(2);
    ...
    if (commission_type == 0 && $("#perc_sales_person").val() != '' && $("#person_sales_person").val()!='') {
        total_company_commission = parseFloat((total_commission) - ((total_commission * salesperson_commission) / 100)).toFixed(2);        
        total_sales_person_commission = parseFloat(total_commission - total_company_commission).toFixed(2);
    } else if (commission_type == 1) {
        total_sales_person_commission = parseFloat($("#sum_sales_person").val()).toFixed(2);
        total_company_commission = parseFloat(total_commission - total_sales_person_commission).toFixed(2);
    }
