    ...
    <div class="card-body">
        <h4 class="card-title">Filters</h4>
            ...
            <div class="form-group mt-5 row">
                ...
                <div class="col-5">
                    <input class="form-control" type="date" value="<?php echo e((isset($formData['endStart']) && $formData['endStart'] !='') ? date('Y-m-d', strtotime($formData['endStart'])) :''); ?>" id="startDate" name='startDate'>
                </div>
                <div class="col-5">
                    <input class="form-control" type="date" value="<?php echo e((isset($formData['endEnd']) && $formData['endEnd'] !='') ? date('Y-m-d', strtotime($formData['endEnd'])) :''); ?>" id="endDate" name='endDate'>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    ...
                    <?php echo e(Form::select('policy_type', [''=>'---Select---']+ $typeArray,  isset($formData['ptype']) ? $formData['ptype'] : '' ,array('id' =>'policy_type','class'=>'custom-select col-12','error-message' =>"Paid type field is mandatory" ))); ?>  
                </div>
            </div>
             ...
             <div class="form-group row">
                ...
                <div class="col-10">
                    ...
                    <?php echo e(Form::select('insurer', [''=>'---Select---']+ $insurer, isset($formData['insurer']) ? $formData['insurer'] : '' ,array('id' =>'insurer','class'=>'custom-select col-12','error-message' =>"Paid type field is mandatory" ))); ?>  
                </div>
            </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-10">
                    ...
                    <?php echo e(Form::select('intallment_type', [''=>'---Select---']+ $statusArray,  isset($formData['installtype']) ? $formData['installtype'] : '' ,array('id' =>'intallment_type','class'=>'custom-select col-12','error-message' =>"Paid type field is mandatory" ))); ?>  
                </div>
            </div>
...
<script>
   ...
   $(function(){
        ...
        $("#filterCancel").on('click',function(){
         ...
         window.location.href = "<?php echo route('installmentreport'); ?>";
