...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Filters</h4>
            ...
            <?php echo e(Form::open(array('route' => 'endorsementfilter', 'name' => 'salesrequestfilter','id'=>'salesrequestfilter','class'=>'') )); ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                <?php echo e(Form::select('endorsement_type',  [''=>'---Select---']+$typeArray,  '' ,array('id' =>'endorsement_type','class'=>'custom-select col-12','error-message' =>"Gender field is mandatory" ))); ?>  
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                <?php echo e(Form::select('endorsement_status',  [''=>'---Select---']+$statusArray,  '' ,array('id' =>'endorsement_status','class'=>'custom-select col-12','error-message' =>"Gender field is mandatory" ))); ?>  
            ...
            <button type="button" class="btn btn-dark" id='filterCancel' redirectUrl='<?php echo e(route('endorsementreport')); ?>'>Cancel</button>
...
<?php if(isset($endorsementDetails)): ?>   
<div class="card">

    <div class="card-body"> 
        <a href="<?php echo e(route('endorsementexport')); ?>"><button type="button" class="btn btn-info d-none d-lg-block m-l-15 pull-right"><i class="mdi mdi-file-export"></i>Export</button></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.elite',['notificationCount'=>0 ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Reports/endorsementlist.blade.php ENDPATH**/ ?>