<div class="card open">
    ...
    <ul class="panel-actions list-inline pull-right">
        <li class="dpib_policy_claim_add" customerId="<?php echo e($customerId); ?>" policyId="<?php echo e($policyId); ?>"><span class="panel-action-add"  data-toggle="tooltip" title="Add a claim" ><span class="fas fa-plus text-blue"></span></span></li>  
                    </ul>
        <h1 class="card-title col-3">Claims<small></small></h1> </div>
       
            <div class="table-responsive" style='width:100%;'>
   
                   <?php echo e(Form::open(array('route' => array('addclaim'), 'name' => 'form_claim_add','id'=>'form_claim_add','files'=>'true' ))); ?> 
...
<script>
   ...
   <?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Policy/claimData.blade.php ENDPATH**/ ?>