...
<?php echo e(Form::open(array('route' => array('updateinstallment',$installmentId), 'name' => 'form_installment_edit','id'=>'form_installment_edit','files'=>'true' ))); ?>
    ...
    <table class="insly_dialogform">
        <tbody>
            ...
            <tr id="field_policy_installment_sum" class="field">
                ...
                <td><div class="element"><input type="text" id="policy_installment_sum" name="policy_installment_sum" value="<?php echo e(number_format($installmentData->amount, 2, '.','')); ?>" autocomplete="off" style="width: 490px; width: 50%;" class="numberfield currencyfield" data-m-dec="2">
                    </div></td>
             </tr>
              <tr id="field_policy_installment_sum" class="field">
                <td class=""><div class="label"><span class="text-danger icon-asterix"></span><span class="title">Vat</span></div></td>
                <td><div class="element"><input type="text" id="policy_installment_vat" name="policy_installment_vat" value="<?php echo e(number_format($installmentData->vat_amount, 2, '.','')); ?>" autocomplete="off" style="width: 490px; width: 50%;" class="numberfield currencyfield" data-m-dec="2" disabled="disabled">
                    </div></td>
             </tr>
              <tr id="field_policy_installment_sum" class="field">
                <td class=""><div class="label"><span class="text-danger icon-asterix"></span><span class="title">Total</span></div></td>
                <td><div class="element"><input type="text" id="policy_installment_sum_vat" name="policy_installment_sum_vat" value="<?php echo e(number_format(($installmentData->amount+$installmentData->vat_amount), 2, '.','')); ?>" autocomplete="off" style="width: 490px; width: 50%;" class="numberfield currencyfield" data-m-dec="2">
                    </div></td>
             </tr>
            ...
            <tr id="field_policy_installment_date" class="field" style="display: none">
                ...
                <td><div class="element">
                        <input type="date" id="policy_installment_date" name="policy_installment_date" value="<?php echo e(date('Y-m-d', strtotime($installmentData->start_date))); ?>" maxlength="10" autocomplete="off" class="datefield" style="margin-right: 0px !important">
                ...
                <td>
                    <div class="element">
                        <select id="policy_installment_collection" name="policy_installment_collection">
                            ...
                            <option value="1" <?php echo e(isset($installmentData->collect_by) ? (($installmentData->collect_by=="1")? 'selected':''): ''); ?> >Broker</option>

                            <option value="2" <?php echo e(isset($installmentData->collect_by) ? (($installmentData->collect_by=="2")? 'selected':''): ''); ?> >insurer</option>

                            <option value="3" <?php echo e(isset($installmentData->collect_by) ? (($installmentData->collect_by=="3")? 'selected':''): ''); ?> >retailer</option>

                            <option value="4" <?php echo e(isset($installmentData->collect_by) ? (($installmentData->collect_by=="4")? 'selected':''): ''); ?> >premium financier</option>
                ...
                <td>
                    <div class="element">
                        <select id="installment_tax" name="policy_installment_tax" data-default-value="5">
                                        ...
                                        <option value="0" <?php echo e(isset($installmentData->vat_percentage) ? (($installmentData->vat_percentage=="0")? 'selected':''): ''); ?>>Nil (0%)</option>

<!--                                        <option value="5" <?php echo e(isset($installmentData->vat_percentage) ? (($installmentData->vat_percentage=="5")? 'selected':''): ''); ?>>VAT (5%)</option>-->
                ...
                <td>
                    <div class="element">
                        <select id="policy_installment_paid_status" name="policy_installment_paid_status">
                            ...
                            <option value="0" <?php echo e(isset($installmentData->paid_status) ? (($installmentData->paid_status=="0")? 'selected':''): ''); ?>>Unpaid</option>

                            <option value="1" <?php echo e(isset($installmentData->paid_status) ? (($installmentData->paid_status=="1")? 'selected':''): ''); ?>>Paid</option>
...
</script><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Policy/editInstallementForm.blade.php ENDPATH**/ ?>