...
//                             }
        ...
        columnDefs.push({"name": 'updatedat',  "targets": 7, "orderable": false, data: function (row, type, val, meta) {
         ...
         columnDefs.push({"name": 'actions',  "targets": 8, "orderable": false, data: function (row, type, val, meta) {
                            var subject = '-'; 
                            var urlString = '<?php echo route("getquoterequesteditform",[$customerId,"##RID"]); ?>';                           
                            var link = urlString.replace("##RID", row['mainId']);
                            var urlString_1 = '<?php echo route("crmrequestOverview",["##RID"]); ?>';
    ...
    var options = {'requestFormUrl':'<?php echo route("getquoterequestform",$customerId); ?>'};
...
</script><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/quote/requestlist.blade.php ENDPATH**/ ?>