   ...
   $(function(){
     ...
     columnDefs1.push({"name": value.name,  "title":value.title,"targets": columnNum, data: function (row, type, val, meta) {
      ...
      leadsTable =   $('.dpib_leads_table').DataTable({
                ajax : {
                            url: "<?php echo e(route('getcustomerdata',['leads'])); ?>",
                            type: "GET",
                            cache: false
                        },
                autoWidth: true,
...
<?php echo $__env->make('layouts.elite',['notificationCount'=>$notificationCount  ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Dashboard/leads.blade.php ENDPATH**/ ?>