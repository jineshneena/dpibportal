...
<script>
   ...
   $(function(){
        ...
        columnDefs.push({"name": 'id/regno',  "targets": 2, "orderable": false, data: function (row, type, val, meta) {
        ...
        columnDefs.push({"name": 'Claimant',  "targets": 4, data: function (row, type, val, meta) {
        ...
        columnDefs.push({"name": 'Claimhandler',  "targets": 5, "orderable": false, data: function (row, type, val, meta) {
        ...
        columnDefs.push({"name": 'Loss date',  "targets": 6, "orderable": false, data: function (row, type, val, meta) {
         ...
         columnDefs.push({"name": 'Submitted date',  "targets": 7, "orderable": false, data: function (row, type, val, meta) {
         ...
         columnDefs.push({"name": 'Insly claim number',  "targets": 8, "orderable": false, data: function (row, type, val, meta) {
...
<?php echo $__env->make('layouts.elite_client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Client/listClaims.blade.php ENDPATH**/ ?>