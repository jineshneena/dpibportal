...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <head>
        ...
        <link href="<?php echo e(asset('elitedesign/dist/css/style.min.css')); ?>" rel="stylesheet">
            ...
            <header class="topbar">
                <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                    ...
                    <div class="navbar-header" >
                        <a class="navbar-brand" href="<?php echo e(route('customerdashboard')); ?>">
                            <!-- Logo icon --><b>
...
<!--                                <img src="<?php echo e(asset('elitedesign/assets/images/logo-icon.png')); ?>" alt="homepage" class="dark-logo" />-->
                            ...
                            <!-- Logo text --><span>
                                <!-- dark Logo text -->
<!--<img src="<?php echo e(asset('elitedesign/assets/images/fullcolor.png')); ?>" alt="homepage" class="dark-logo" />-->
                                <!-- Light Logo text -->    
                        ...
                        <ul class="navbar-nav my-lg-0">
                            ...
                            <li class="nav-item dropdown u-pro">
                                ...
                                <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                    <!-- text-->
                                    <a href="<?php echo e(route('profile',Auth::user()->customer_id)); ?>" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
                                    <!-- text-->
                        ...
                        <ul id="sidebarnav">
                            ...
                            <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="<?php echo e(asset('Images/avatar.jpg')); ?>" alt="user-img" class="img-circle"><span class="hide-menu"><?php echo e(Auth::user()->name); ?></span></a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="<?php echo e(route('profile',Auth::user()->customer_id)); ?>"><i class="ti-user"></i> My Profile</a></li>                             
...
<!--                                    <li><a href="/changePassword"><i class="ti-settings"></i> Change password</a></li>-->
                              ...
                              <li> <a class="waves-effect waves-dark" href="<?php echo e(route('customerdashboard')); ?>" aria-expanded="false"><i class="far fa-circle text-danger"></i><span class="hide-menu">Dashboard</span></a></li>
                    ...
                    <div class="row page-titles">
                        ...
                        <div class="col-md-12 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('customerdashboard')); ?>" style='color:#03a9f3;'>Home</a></li>
                                    <li class="breadcrumb-item middlemenu" ></li>
                                    <li class="breadcrumb-item active text-info breadcrum-last" ></i><a href="<?php echo e(route('customerdashboard')); ?>" id='breadcrumbBack' style='color:#03a9f3;text-transform: capitalize;'></a></li>
...
</html><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/layouts/elite_client.blade.php ENDPATH**/ ?>