            ...
            <div class="panel-body" id="fieldgroup_policy">
                <table class="insly-form">
                    <tbody>
                            ...
                            <td><div class="element"><input type="text" class="form-control" id="policy_number" name="policy_number" value="<?php echo e($policyData->policy_number); ?>" <?php if($policyData->policy_status==2): ?> disabled <?php endif; ?> maxlength="50" autocomplete="off"  style="margin-right: 0px !important" ></div></td>
                           </tr>
                        <tr id="field_policy_type" class="field ">
                            ...
                            <td>
                                <div class="element">
                                    <select id="policy_type" name="policy_type" class="form-control" <?php if($policyData->policy_status==2): ?> disabled <?php endif; ?>>
