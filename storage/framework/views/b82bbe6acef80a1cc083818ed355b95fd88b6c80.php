...
<script>
    var isLock=false;
 $(document).on('click','#policy_endorsement_date_start',function(){

        $.ajax({
                                                    url: "<?php echo route('checklock'); ?>",
                                                            type: "GET",
                                                            data :{'selectedDate':$("#policy_endorsement_date_issue").val()}
     ...
     $(document).on('click','#policy_endorsement_no',function(){
...
$("#form_endorsement_save" ).submit(function( event ) {
        ...
        var isValid = true;
                              ...
                              if(regex.test(test) === false || $("#policy_endorsement_premium").val()<0){
