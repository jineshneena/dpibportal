...
<div class="panel panel-default open card">
    <div class="panel-heading card-body">
     <ul class="panel-actions list-inline pull-right dib_head">   
         <li class="dpib_endorsement_request_add" data-url='<?php echo route("addnewendorsementrequest"); ?>' data-customer="<?php echo e(Auth::user()->customer_id); ?>" >
...
<script>
   ...
   $(function(){
        ...
        columnDefs.push({"name": 'requestid',  "targets": 0, data: function (row, type, val, meta) {
                            ...
                            var urlString = '<?php echo route("overviewcustomerendorsementrequest",["##PID","##RID"]); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.elite_client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Client/requestFilter.blade.php ENDPATH**/ ?>