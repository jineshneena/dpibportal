<?php if(isset($endorsementId)): ?>

                        <?php echo e(Form::open(array('route' => array('updateendorsementdetails', $policy_id,$endorsementId),'name' => 'form_endorsement_save','id'=>'form_endorsement_save') )); ?>

                        <?php else: ?>
                       <?php echo e(Form::open(array('route' => array('saveendorsementdetails',$policy_id), 'name' => 'form_endorsement_save','id'=>'form_endorsement_save') )); ?>
          ...
          <div class="dialogform">
              <table class="insly_dialogform">
                        ...
                        <tr id="field_policy_endorsement_no" class="field ">
                            ...
                            <td colspan="4">
                                <div class="element">
                                    ...
                                    <input type="text" id="policy_endorsement_no" name="policy_endorsement_no" value="<?php echo e(isset($endorsementData->endorsement_number) ? $endorsementData->endorsement_number : ''); ?>" autocomplete="off" maxlength="255" class="form-control required" error-message="Endorsement number field is mandatory">
                                </div>
                            </td>
                        </tr>
                          <tr id="field_policy_endorsement_count" class="field"><td class=""><div class="label"><span class="text-danger icon-asterix"></span>
                                    ...
                                    <td colspan="4"><div class="element">
                                            <input type="number" id="policy_endorsement_count" name="policy_endorsement_count" value="<?php echo e(isset($endorsementData->endorsement_count) ? $endorsementData->endorsement_count  : 0); ?>" maxlength="10" autocomplete="off" class="form-control" error-message="Endorsement count is field is mandatory" style="margin-right: 0px !important">
                    ...
                    <tr id="field_policy_endorsement_no" class="field ">
                            ...
                            <td colspan="4">
                                <div class="element">
                                   <?php echo e(Form::select('endorsement_type',  $typeArray, isset($endorsementData->endorsement_type) ? $endorsementData->endorsement_type : '' ,array('id' =>'endorsement_type','required'=>'required','class'=>'required form-control','error-message' =>"Gender field is mandatory" ))); ?>  
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr id="field_policy_endorsement_date_start" class="field">
                            ...
                            <td colspan="4"><div class="element"><input type="date" id="policy_endorsement_date_start" name="policy_endorsement_date_start" value="<?php echo e(isset($endorsementData->start_date) ? date('Y-m-d', strtotime($endorsementData->start_date))  : date('Y-m-d')); ?>" maxlength="10" autocomplete="off" class="form-control" style="margin-right: 0px !important"><div style="float: right; width: 40%; padding-left: 10px; padding-top: 9px; overflow: hidden"><div id="policy_endorsement_date_start_comment"></div></div></div></td>
                        </tr>  
                         <tr id="field_policy_endorsement_due_date" class="field">
                            ...
                            <td colspan="4"><div class="element"><input type="date" id="policy_endorsement_due_date" name="policy_endorsement_due_date" value="<?php echo e(isset($endorsementData->due_date) ? date('Y-m-d', strtotime($endorsementData->due_date))  : date('Y-m-d')); ?>" maxlength="10" autocomplete="off" class="form-control" style="margin-right: 0px !important"><div style="float: right; width: 40%; padding-left: 10px; padding-top: 9px; overflow: hidden"><div id="policy_endorsement_due_date_comment"></div></div></div></td>
                        </tr>
                            ...
                            <td colspan="4">
                                <div class="element">
                                     <select id="installment_tax" name="endorsement_tax" data-default-value="5" class="form-control">
                                        ...
                                        <option value="0" <?php echo e(isset($endorsementData->vat_percentage) ? (($endorsementData->vat_percentage=="0")? 'selected':''): ''); ?>>Nil (0%)</option>

<!--                                        <option value="5" <?php echo e(isset($endorsementData->vat_percentage) ? (($endorsementData->vat_percentage=="5")? 'selected':''): ''); ?>>VAT (5%)</option>-->
...
<?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Endorsement/createendorsement.blade.php ENDPATH**/ ?>