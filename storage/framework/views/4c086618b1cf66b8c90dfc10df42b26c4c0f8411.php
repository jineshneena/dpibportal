        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex no-block align-items-center m-t-20 m-b-20">
                    ...
                    <div class="ml-auto">
                        <h2 class="text-success"><i class="ti-arrow-up"></i> <span class="counter"><?php echo e($dashboardDetails['endorsementcount']); ?></span></h2>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex no-block align-items-center m-t-20 m-b-20">
                    ...
                    <div class="ml-auto">
                        <h2 class="text-info"><i class="ti-arrow-up"></i> <span class="counter"><?php echo e($dashboardDetails['complaintcount']); ?></span></h2>
                    </div>
                </div>
            </div>
            <div id="sparkline8" class="sparkchart"></div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex no-block align-items-center m-t-20 m-b-20">
                    ...
                    <div class="ml-auto">
                        <h2 class="text-danger"><i class="ti-arrow-up"></i> <span class="counter"><?php echo e(number_format($dashboardDetails['endorsemetsum'], 0, '.', ',')); ?></span></h2>
                    </div>
                </div>
            </div>
            <div id="sparkline8" class="sparkchart"></div>
   ...
   var pcolumnDefs = [];
    var claimTable = '';
      ...
      claimTable =   $('.dpib_claim_list').DataTable( {
                data: <?php echo $dashboardDetails['claimDetails']; ?>,
                autoWidth: true,
                stateSave: false,
    ...
    var complaintTable = '';
     ...
     comcolumnDefs.push({"name": 'status',  "targets": 5, "orderable": false, data: function (row, type, val, meta) {
      ...
      complaintTable =   $('.dpib_policy_list').DataTable( {
                data: <?php echo $dashboardDetails['complaintDetails']; ?>,
                autoWidth: true,
                stateSave: false,
                stateDuration: 60 * 60 * 24,
                responsive: true,
...
<?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Dashboard/operationdashboard.blade.php ENDPATH**/ ?>