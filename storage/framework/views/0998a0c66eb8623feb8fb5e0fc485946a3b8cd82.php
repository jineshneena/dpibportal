...
<div class="card">
    <div class="card-body">
        ...
        <?php echo e(Form::open(array('route' => array('getrenewalrequestdata'), 'name' => 'salesrequestfilter','id'=>'salesrequestfilter','class'=>'') )); ?>
        ...
        <button type="button" class="btn btn-dark" id='filterCancel' redirectUrl='<?php echo e(route('reportrenewalrequest')); ?>'>Cancel</button>
...
<?php if(isset($renewalrequestDetails)): ?>
<div class=" card">
    <div class="card-body">

        <a href="<?php echo e(route('renewalrequestexport')); ?>"><button type="button" class="btn btn-info d-none d-lg-block m-l-15 pull-right"><i class="mdi mdi-file-export"></i> Export</button></a>
...
data: <?php echo $renewalrequestDetails; ?>,
        autoWidth: true,
        stateSave: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.elite',['notificationCount'=>0 ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Reports/renewalrequest.blade.php ENDPATH**/ ?>