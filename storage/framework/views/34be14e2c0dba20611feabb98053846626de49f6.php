...
<?php $__env->stopSection(); ?>
    ...
    <div class="col-md-12 card">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <?php if(in_array($overviewData->type, [1,3,4,9]) && in_array($overviewData->status, [3,6,7,8,10])): ?>
            ...
            <div class="col-md-12 row button-group">
                <div class="col-lg-6 col-xlg-6 mb-4" style='margin-left:26px'>
                   <?php if(in_array('CUSTOMER_OFFICER', Auth::user()->roles) || in_array('CUSTOMER_MANAGER', Auth::user()->roles) ): ?>
                            ...
                            <?php if(in_array('CUSTOMER_MANAGER', Auth::user()->roles)  ||  Auth::user()->id == $overviewData->created_by): ?>
                            
                                <?php if($overviewData->status ==1): ?>
                                    ...
                                    <button type="button" class="btn btn-success btn-rounded dpib_endorsement_crm_delete dib-cursor-style" delete_url="<?php echo route('deleteendorsementcrmrequest',$requestId); ?>" return-url="<?php echo route('customerrequestfilter'); ?>" data-toggle="tooltip" title="" data-original-title="Delete request"><i class="fas fa-archive"></i> Delete</button>                          
                    ...
                    <div id="customer_overview" class="panel-collapse panel-body ">
                        <table class="info-table" width='100%'>
                            <tbody>
                                ...
                                <tr><td>Policy no:</td><td><a href='<?php echo e(route("clientpolicyoverview",$policyId)); ?>'><b><?php echo e($overviewData->policy_number); ?></b></a></td></tr>
    ...
    <div id="content_endorsement" class="tabcontent col-12"  style="display:none;">
        ...
        <div class="table-responsive">
                    ...
                    <tr>
                        ...
                        <td><?php echo e($endorsementDetail->endorsement_number); ?></td>
...
<script id='endorsement_request_assign_template' type='text/template'>
    ...
    <?php echo e(Form::open(array('route' => array('assignOwner',$overviewData->id), 'name' => 'form_endorsement_request_assign','id'=>'form_endorsement_request_assign','files'=>'true' ))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make((in_array('CUSTOMER_MANAGER', Auth::user()->roles) ||  in_array('CUSTOMER_OFFICER', Auth::user()->roles))? 'layouts.elite_client'  :'layouts.elite_fullwidth' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Client/overviewendorsementrequest.blade.php ENDPATH**/ ?>