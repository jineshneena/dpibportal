...
<div class="row">
 <?php $__env->startSection('headtitle'); ?>
         <a href='<?php echo e(route("policyoverview",$policyId)); ?>'><?php echo e($overviewData->policy_number); ?></a> <i class="fas fa-angle-double-right"></i><span class='text-blue' style='font-size:25px'><?php echo e($overviewData->request_id); ?> </span>
        ...
        <div class="row">
            ...
            <div class="col-md-12 row button-group">
                <div class="col-lg-6 col-xlg-6 mb-4" style='margin-left:26px'>
                   <?php if(in_array('ROLE_OPERATION_MANAGER', Auth::user()->roles) || in_array('ROLE_OPERATION', Auth::user()->roles) || in_array('ROLE_OPERATION_LEAD', Auth::user()->roles)): ?>
                            ...
                            <?php if(in_array('ROLE_OPERATION_MANAGER', Auth::user()->roles) ||  Auth::user()->id == $overviewData->created_by || Auth::user()->id == $overviewData->assign_to): ?>
                             <button type="button" class="btn btn-success btn-rounded dpib_endorsement_request_edit dib-cursor-style" editUrl='<?php echo route("editcrmrequestdata",[$policyId, $requestId]); ?>' data-toggle="tooltip" title="" data-original-title="Edit endorsement request"><i class="fas fa-edit"></i> Edit</button>                          
                            <?php endif; ?> 
                            <?php if(in_array('ROLE_OPERATION_MANAGER', Auth::user()->roles)  ||  in_array('ROLE_OPERATION_LEAD', Auth::user()->roles)): ?>
                            
                 <?php if($overviewData->type !=17): ?>
                            
                            <button type="button" class="btn btn-success btn-rounded dpib_endorsement_crm_delete dib-cursor-style" delete_url="<?php echo route('deleteendorsementcrmrequest',$requestId); ?>" return-url="<?php echo route('dashboardendorsementlist'); ?>" data-toggle="tooltip" title="" data-original-title="Delete request"><i class="fas fa-archive"></i> Delete</button>                          
                       <?php endif; ?>    
                            <button type="button" class="btn btn-success btn-rounded dpib_endorsement_crm_assign dib-cursor-style"  data-toggle="tooltip" title="" data-original-title="Assign request"><i class="fas fa-handshake"></i> Assign</button>                          
                            <?php endif; ?>
                ...
                <div class="col-lg-6 col-xlg-6 mb-4" style='text-align:right;margin-left:-118px'>
                 <?php if(in_array('ROLE_OPERATION_MANAGER', Auth::user()->roles) ||  Auth::user()->id == $overviewData->created_by || Auth::user()->id == $overviewData->assign_to): ?>
                    <?php echo e(Form::open(array('route' => array('updateendorsementrequeststatus', $policyId), 'name' => 'form_crm_status_edit','id'=>'form_crm_status_edit','files'=>'true' ))); ?>
                                                       ...
                                                       <?php $__currentLoopData = $statusArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$statusdetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($overviewData->status !=$key): ?>
                                                             <?php if($iCount ==4): ?>
                                                              <div class="btn-group">
                                                                  <?php
                                                            $moremenu =true;
                                                      ...
                                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <?php if($moremenu ==true): ?>
                                                              </div>
                                                        <?php endif; ?>
                                                      <input type='hidden' name='request_status' class="crm_status" value='<?php echo e($overviewData->status); ?>' />
                ...
                <div id="panel-customer_overview" class="panel panel-default open"><div class="panel-heading">
                    ...
                    <div id="customer_overview" class="panel-collapse panel-body ">
                        <table class="info-table" width='100%'>
                            <tbody>
                                <tr><td style='width:45%'>CRM No:</td><td><b><?php echo e($overviewData->request_id); ?></b></td></tr>
                                <tr><td>Type:</td><td><?php echo e($typeArray[$overviewData->type]); ?> </td></tr>
                                <tr><td>Policy no:</td><td><a href='<?php echo e(route("policyoverview",$policyId)); ?>'><b><?php echo e($overviewData->policy_number); ?></b></a></td></tr>
                                 <?php if( in_array('CUSTOMER_MANAGER', Auth::user()->roles) ||  in_array('CUSTOMER_OFFICER', Auth::user()->roles) ): ?>
                                 
                                 <?php else: ?>
                                 <tr><td>Customer:</td><td><b>   <a href='<?php echo e(route('customeroverview',$overviewData->customer_id)); ?>'><?php echo e(ucfirst(trans($overviewData->customerName))); ?></a> </b></td></tr>
                                 <?php endif; ?>
                                ...
                                <tr style='display: none'><td>Is INSLY entered ?</td><td><div class="custom-control custom-switch">
                                ...
                                <tr>
                                    <td style='width:35%'>
                                        <span class='text-warning'> 
                                            ...
                                            <?php endif; ?>
                                        </span><br/><span  class="text-warning"> <?php echo e(date('d.m.Y h:i:s A',strtotime($commentDetail-> created_at))); ?></span>
                                    </td>
                                   
                                    <td><span style="margin-left:10px"><i><?php echo e($commentDetail->comments); ?></i></span></td>
    ...
    <div id="content_endorsement" class="tabcontent col-12"  style="display:none;">
        ...
        <div class="table-responsive">
                                    <table class="table color-table">
                                        ...
                                        <tbody>
                          <?php if(count($endorsementDetails) >0): ?>                  
                              <?php $__currentLoopData = $endorsementDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $endorsementDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                    <tr>
                        
                        <td><a href="<?php echo e(route('overviewendorsement',[$endorsementDetail->id])); ?>" target='_blank'><?php echo e($endorsementDetail->endorsement_number); ?></a></td>
                       
                        <td><?php echo e($endorsementDetail->typeString); ?></td>
                        <td><?php echo e(floatval($endorsementDetail->amount)); ?></td>
                         <td><?php echo e(date('d.m.Y',strtotime($endorsementDetail->issue_date))); ?></td>
                        <td><?php echo e(date('d.m.Y',strtotime($endorsementDetail->due_date))); ?></td>
                        <td><?php echo e(date('d.m.Y h:i',strtotime($endorsementDetail->created_at))); ?></td>
                        <td><?php echo e($endorsementDetail->statusString); ?></td>                        
                    </tr>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script id='announcement_document_upload_template' type='text/template'>
    <?php echo e(Form::open(array('route' => array('updateannouncementrequeststatus', $overviewData->id), 'name' => 'form_announcement_status','id'=>'form_announcement_status','files'=>'true' ))); ?>
...
<script>
                                    ...
                                    var erType = <?php echo $overviewData->type; ?>
    ...
    $(document).on('click','.dpib-status-change',function(){
            ...
            if(erType ==17 && selectedStatus==3) {
              
            var template = _.template($("#announcement_document_upload_template").html());
                                    $(".preloader").hide();
                                    var data = {};
                                    var result = template(data);
                                    $("#db_endorsement_request_docpopup").remove();
                                    $('body').append('<div id="db_endorsement_request_docpopup" title="Upload announcement email" style="display:none" >' + result + '</div>');
                                    var dialogElement = $("#db_endorsement_request_docpopup");
                                    dialogElement.dialog({
                                    width: 900,
                                            modal: true,
                                                                ...
                                                                var checkFlag = FORM.validateFile($('#document_file'), 128, 'Maximum file upload size 128 MB exceeded!');
                                                                    if($("#documenttype_oid").val()=='') {
                                                                        DIB.displayErrors("Document type is mandatory", LOCALE.get('insly.common.whoops'));   
                                                                             ...
                                                                             $(".preloader").show();
                                                                            $("form#form_announcement_status").submit();  
                                                                    }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make((in_array('CUSTOMER_MANAGER', Auth::user()->roles) ||  in_array('CUSTOMER_OFFICER', Auth::user()->roles))? 'layouts.elite_client'  :'layouts.elite_fullwidth' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Policy/overviewendorsementrequest.blade.php ENDPATH**/ ?>