                ...
                <td>
                    <div class="element">
                       ...
                       <?php endif; ?>
                        ...
                        <?php echo e(Form::select('crm_type', array(''=>'---Not set---',1 => 'Request',3=>'Renewal'),isset($requestDetails->type) ? $requestDetails->type:1,$fieldArray)); ?>
...
<!--            <tr id="field_task_description" class="field dib_task">
                ...
                <td>
                    <div class="element">
                        <textarea class="note_add_entry full-width" name="task_description" rows="10" wrap="soft" ><?php echo e(isset($requestDetails->description) ? $requestDetails->description:''); ?></textarea>
                    </div>
                </td>
            </tr>-->
            ...
            <?php endif; ?>
             <tr id="field_customer_gender" class="field customertype" >
               ...
               <tr id="field_dib_old_policies" class="field dib_old_policies" style='display:none'>
                ...
                <td>
                    <div class="element" >
                         <?php echo e(Form::select('activePolicyList', ['' =>'----Not Select----'], '',array('id' =>'activePolicyList','required'=>'required','style'=>'width: 100%;','class'=>'request_lineof_business required form-control custom-select','error-message' =>"Policy  field is mandatory" ))); ?>
            ...
            <tr id="field_request_description" class="field dib_request">
                ...
                <td>
                    <div class="element">
                        <textarea class="note_add_entry full-width" name="request_description" rows="10" wrap="soft" ><?php echo e(isset($requestDetails->description) ? $requestDetails->description:''); ?></textarea>
                    </div>
                </td>
            </tr>
...
<?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/quote/requestaddform.blade.php ENDPATH**/ ?>