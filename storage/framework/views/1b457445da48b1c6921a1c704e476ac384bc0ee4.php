...
<script>
   ...
   $(function(){
        ...
        columnDefs1.push({"name": 'filename',  "targets": 0, data: function (row, type, val, meta) {
                            ...
                            var linkString = "<a href='<?php echo route('getCustomerDownload',['##CID',0,'##FILE']); ?>'>"+subject+"</a>";
                            var link = linkString.replace("##CID", row['customer_id']).replace("##FILE", subject);
                            if(row['endorsement_id'] !=null && row['policy_id']!=null) {
...
</script><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/customer/documentData.blade.php ENDPATH**/ ?>