...
<?php echo e(Form::open(array('route' => array('saveconnectiondetails', $customerId), 'name' => 'form_customer_connection_add','id'=>'form_customer_connection_add','files'=>'true' ))); ?>
        ...
        <tbody>
            <tr id="field_customer_2_oid" class="field"><td class="">
                ...
                <td><div class="element">
                        <?php echo e(Form::select('customer_id',  $allCustomers, $customerId,array('name'=>'related_customer_id','id' =>'related_customer_id','required'=>'required','class'=>'required','error-message' =>"Insurance company field is mandatory"))); ?>
...
<?php echo e(Form::close()); ?> <?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/customer/customerconnectionform.blade.php ENDPATH**/ ?>