...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Filters</h4>
            ...
            <?php echo e(Form::open(array('route' => 'invoicefilter', 'name' => 'salesrequestfilter','id'=>'salesrequestfilter','class'=>'') )); ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    ...
                    <?php echo e(Form::select('invoice_status', [''=>'---Select---']+ $statusArray,  '' ,array('id' =>'invoice_status','class'=>'custom-select col-12','error-message' =>"Gender field is mandatory" ))); ?>  
                </div>
            </div>
            
            
            <button type="submit" class="btn btn-success mr-2">Generate report</button>
            <button type="button" class="btn btn-dark" id='filterCancel' redirectUrl='<?php echo e(route('invoicereport')); ?>'>Cancel</button>
...
<div class=" card">
    <div class="card-body">
 <a href="<?php echo e(route('invoiceexport')); ?>"><button type="button" class="btn btn-info d-none d-lg-block m-l-15 pull-right"><i class="mdi mdi-file-export"></i> Export</button></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.elite',['notificationCount'=>0 ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Reports/financeinvoice.blade.php ENDPATH**/ ?>