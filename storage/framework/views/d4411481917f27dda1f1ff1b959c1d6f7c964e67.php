...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Filters</h4>
            ...
            <?php echo e(Form::open(array('route' => 'requestfilter', 'name' => 'salesrequestfilter','id'=>'salesrequestfilter','class'=>'') )); ?>
            ...
            <button type="button" class="btn btn-dark" id='filterCancel' redirectUrl='<?php echo e(route('operationrequestreport')); ?>'>Cancel</button>
...
<div class="card">
    <div class="card-body">
        <a href="<?php echo e(route('requestexport')); ?>"><button type="button" class="btn btn-info d-none d-lg-block m-l-15 pull-right"><i class="mdi mdi-file-export"></i> Export</button></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.elite_fullwidth',['notificationCount'=>0  ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Reports/operationrequest.blade.php ENDPATH**/ ?>