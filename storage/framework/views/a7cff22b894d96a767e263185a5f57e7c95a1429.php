...
<div class="card open">
    ...
    <div class="panel-heading">
        <ul class="panel-actions list-inline pull-right">
          <li  id='dp_generate_broken_slip' openUrl='<?php echo route("brokenslipmainform",[$customerId,$crmId]); ?>' class="dib-cursor-style"><span class="panel-action-add"  data-toggle="tooltip" title="Add a broking slip" ><span class="fas fa-plus text-blue"></span></span></li>  
          <li  id='dpib_brokingslip_upload' openUrl='<?php echo route("brokenslipmainform",[$customerId,$crmId]); ?>' class="dib-cursor-style" style="padding-left:2px;margin-left:0px;"><span class="panel-action-add"  data-toggle="tooltip" title="Upload a broking slip" ><span class="fas fa-upload text-blue"></span></span></li>
        </ul> 
...
<script id='brokingslip_upload_template' type='text/template'>
        ...
        <?php echo e(Form::open(array('route' => array('uploadbrokingslip',$customerId, $crmId), 'name' => 'form_brokingslip_generation','id'=>'form_brokingslip_generation','files'=>'true' ))); ?>
...
<script>
   ...
   $(function(){
        ...
        columnDefs.push({"name": 'filename',  "targets": 0, data: function (row, type, val, meta) {
                            ...
                            linkString = "<a href='<?php echo route('getfiledownload',['##CID','brokingslip','##CRMID','##FILE',0]); ?>'>"+subject+"</a>";                             
        ...
        columnDefs.push({"name": 'Uploaded at',  "targets": 5, "orderable": false, data: function (row, type, val, meta) {
         ...
         columnDefs.push({"name": 'actions',  "targets": 6, "orderable": false, data: function (row, type, val, meta) {
                            ...
                            displayString = '<a href="<?php echo route("viewfile",["##CID","brokingslip","##CRMID","##FILE"]); ?> " target="_blank"><span class="fas fa-eye text-blue mr-right" data-toggle="tooltip" title="" data-original-title="View brokingslip"></span></a>';
                            displayString+= '&nbsp;&nbsp;<a class="dpib_brokingslip_sendmail" openUrl="<?php echo route("sendbrokenslippopup",["##CID","##CRMID","##MAINID"] ); ?>" data-title="Send broking slip"><span class="fas fa-envelope text-blue mr-right" data-toggle="tooltip" title="" data-original-title="Send email" ';
                            if(row['sendmail_flag']==1) {
                              displayString+=' style=color:red'+'></span></a>';  
                            } else {
                               displayString+=' ></span></a>'; 
                            }
                            displayString+='&nbsp;&nbsp;<a class="dpib_delete_brokingslip" actionUrl="<?php echo route("deletebrokingslip",["##CID","##CRMID","##FILE","##MAINID"]); ?>"><span class="fas fa-times-circle text-blue mr-right" data-toggle="tooltip" title="" data-original-title="Delete brokingslip"></span></a>';
                            if(row['quotes_id'] ==null) {
                             displayString+='&nbsp;&nbsp;<a class="dpib_upload_quote" actionUrl="<?php echo route("quoteuploadform",["##CID","##CRMID","##MAINID"]); ?>"><span class="fas fa-upload text-blue" data-toggle="tooltip" title="" data-original-title="Upload quotes"></span></a>';   
                            }
...
</script><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Brokenslip/brokingslipList.blade.php ENDPATH**/ ?>