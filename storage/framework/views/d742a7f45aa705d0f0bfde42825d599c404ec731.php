...
<div class="card">
    <div class="card-body">
        <h4 class="card-title">Filters</h4>
            ...
            <?php echo e(Form::open(array('route' => 'productionfilter', 'name' => 'salesrequestfilter','id'=>'salesrequestfilter','class'=>'') )); ?>
            ...
            <button type="button" class="btn btn-dark" id='filterCancel' redirectUrl='<?php echo e(route('productionreport')); ?>'>Cancel</button>
...
<div class=" card">
 ...
 <a href="<?php echo e(route('productionexport')); ?>"><button type="button" class="btn btn-info d-none d-lg-block m-l-15 pull-right"><i class="mdi mdi-file-export"></i> Export</button></a>
       ...
       rencolumnDefs.push({"name": "sumofpremium",  "targets": 2, "orderable": false,data: function (row, type, val, meta) {
        ...
        rencolumnDefs.push({"name": 'segmant',  "targets": 3, "orderable": false, data: function (row, type, val, meta) {
             ...
             renewalTable =   $('.dpib_renewal_list').DataTable( {
                data: <?php echo $clientsegmantDetails; ?>,
                autoWidth: true,
                stateSave: false,
                stateDuration: 60 * 60 * 24,
                responsive: true,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.elite',['notificationCount'=>0 ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Reports/production.blade.php ENDPATH**/ ?>