                                ...
                                <div class="col-12">
                                    <div class="social-widget">
                                        ...
                                        <div class="soc-content">
                                            <div class="col-6 b-r">
                                                <h3 class="font-medium"><?php echo e($countDetails['request']['active']); ?></h3>
...
<!--                                               <div class="col text-right align-self-center col-4" >
                                            ...
                                            <div class="col-6">
                                                <h3 class="font-medium"><?php echo e($countDetails['request']['closed']); ?></h3>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="social-widget">
                                        ...
                                        <div class="soc-content">
                                            <div class="col-6 b-r">
                                                <h3 class="font-medium"><?php echo e($countDetails['claim']['active']); ?></h3>
                                                <h5 class="text-muted">Active</h5></div>
                                            <div class="col-6">
                                                <h3 class="font-medium"><?php echo e($countDetails['claim']['closed']); ?></h3>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="social-widget">
                                        ...
                                        <div class="soc-content">
                                            <div class="col-6 b-r">
                                                <h3 class="font-medium"><?php echo e($countDetails['complaint']['active']); ?></h3>
                                                <h5 class="text-muted">Active</h5></div>
                                            <div class="col-6">
                                                <h3 class="font-medium"><?php echo e($countDetails['complaint']['closed']); ?></h3>
                                                <h5 class="text-muted">Closed</h5></div>
                                        </div>
                                    </div>
                                </div>
...
<link rel="stylesheet" type="text/css" href=" <?php echo e(asset('elitedesign/assets/node_modules/css-chart/css-chart.css')); ?> ">
...
<?php echo $__env->make('layouts.elite_client' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Client/dashboard.blade.php ENDPATH**/ ?>