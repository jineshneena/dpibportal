...
<div class="alert alert-warning alert-block" style='display:none'>
            ...
            <?php echo e(Form::open(array('route' => 'financepostrequestfilter', 'name' => 'salesrequestfilter','id'=>'salesrequestfilter','class'=>'') )); ?>
         ...
         <div class="form-group mt-5 row">
                ...
                <div class="col-10">
                   <?php echo e(Form::select('post_status', [''=>'---Select---']+ $poststatusArray, isset($formData['status']) ? $formData['status'] : '' ,array('id' =>'post_status','class'=>'custom-select col-12','error-message' =>"Gender field is mandatory" ))); ?> 
                </div>
...
<div class=" card">
 ...
 <a href="<?php echo e(route('postrequestreportexport')); ?>"><button type="button" class="btn btn-info d-none d-lg-block m-l-15 pull-right"><i class="mdi mdi-file-export"></i> Export</button></a>
...
<script>
 ...
 $(document).on('click','#filterCancel',function(){
   window.location.href = "<?php echo e(route('financeproductionreport')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.elite',['notificationCount'=>0 ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Reports/postrequest.blade.php ENDPATH**/ ?>