        ...
        <div class="card">
            <div class="card-body">
                <div class="insly-form">
                    ...
                    <?php echo e(Form::open(array('route' => array('saverequestinfo', $customer), 'name' => 'form_request_add','id'=>'form_quote_request_add','files'=>'true' ))); ?>
                        ...
                        <div class="panel-body" id="fieldgroup_customer">
                            <table class="insly-form" id="request_add_table">
                               <tr id="field_policy_oid" class="field ">
                                    ...
                                    <td>
                                        <div class="element">
                                            <?php echo e(Form::select('request_type', [''=>'--Select--']+$requestType, '',array('id' =>'request_type','required'=>'required','class'=>'required form-control','error-message' =>"Request type field is mandatory" ))); ?> 
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr id="field_policy_oid" class="field ">
                                    ...
                                    <td>
                                        <div class="element">
                                            <?php echo e(Form::select('request_policy',  $policies, '',array('id' =>'request_policy','required'=>'required','class'=>'required form-control','error-message' =>"Policy field is mandatory" ))); ?> 
                                        </div>
                                    </td>
                                </tr>  
                            </table>
   ...
   <div class="buttonbar pull-right">
    ...
    <script id='endorsement_request_add_template' type='text/template'>
       ...
       <tr id="field_request_type" class="field newfield">
            ...
            <td>
                ...
                <div class="element">
                <?php echo e(Form::select('endorsement_type',  $endorsementType, '',array('id' =>'endorsement_type','required'=>'required','class'=>'required form-control','error-message' =>"Gender field is mandatory" ))); ?>  
                </div>
            </td>
        </tr>
    ...
    <script id='complaint_request_add_template' type='text/template'>
        <tr id="field_request_type" class="field newfield">
            ...
            <td>
                ...
                <div class="element">
                <?php echo e(Form::select('complaint_type',  $complaintType, '',array('id' =>'complaint_type','required'=>'required','class'=>'required form-control','error-message' =>"Gender field is mandatory" ))); ?>  
                </div>
            </td>
        </tr>
    ...
    <script id='claim_request_add_template' type='text/template'>
        <tr id="field_claim_date_incident" class="field newfield">
            ...
            <td>
                <div class="element">
                <input type="datetime-local" id="claim_date_incident" name="claim_date_incident"   value="<?php echo e(date('d.m.Y')); ?>" class="datefield form-control" style="margin-right: 0px !important"/>
    ...
    $(function(){
     ...
     <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.elite_client' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp_new\htdocs\inslyportal\resources\views/Client/addRequest.blade.php ENDPATH**/ ?>