            ...
            <div class="panel-body" id="fieldgroup_policy">
                <table class="insly-form">
                    <tbody>
                            ...
                            <td><div class="element"><input type="text" class="form-control" id="policy_number" name="policy_number" value="{{$policyData->policy_number}}" maxlength="50" autocomplete="off"  style="margin-right: 0px !important" ></div></td>
                           </tr>
