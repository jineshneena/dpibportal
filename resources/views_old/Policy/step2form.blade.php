        ...
        <div class="panel panel-default panel-dark">
         ...
         {{ Form::select('old_policies',  array(""=>"--- not set ---")+$oldPolicies, null,array('name'=>'old_policy_number','id' =>'old_policy_number','error-message' =>"Old policy number field is mandatory",'class'=>'form-control required' ))}}  
