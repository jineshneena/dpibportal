...
<div class="panel panel-default open">
    <div class="panel-heading">
     <ul class="panel-actions list-inline pull-right">   
         <li class="dpib_quote_request_add"><a href='{!! route("createpolicy") !!}'><span class="panel-action-add"  data-toggle="tooltip" title="Add Policy"><span class="icon-add"></span></span></a></li> 
     </ul> 
