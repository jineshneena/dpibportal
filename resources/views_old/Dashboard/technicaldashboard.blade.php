        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex no-block align-items-center m-t-20 m-b-20">
                    ...
                    <div class="ml-auto">
                        <h2 class="text-purple"><i class="ti-arrow-up"></i> <span class="counter">{{$dashboardDetails['quoteCount']}}</span></h2>
                    </div>
                </div>
            </div>
            <div id="sparkline8" class="sparkchart"></div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <h5 class="card-title m-b-40">TECHNICAL IN {{date('Y')}}</h5>
        ...
        <div class="card">
            <div class="card-body">
                <ul class="panel-actions list-inline pull-right dib_head" >
                                ...
                                <li ><a class="dpib_quote_request_add large-size"  href='{{ route('customeradd') }}'><span class="icon-add fas fa-plus large-size" data-toggle="tooltip" title="" data-original-title="Add customer" data-toggle="modal" data-target="#dpib_quote_request_add"></span></a></li>
 ...
 var encolumnDefs = [];
    var policyTable = '';
      ...
      policyTable =   $('.dpib_policy_list').DataTable( {
                data: {!! $dashboardDetails['allpolicies'] !!},
                autoWidth: true,
                stateSave: false,
    ...
    var customerQuoteTable = '';
     qcolumnDefs.push({"name": "customername",  "targets": 0, "orderable": false,data: function (row, type, val, meta) {
      ...
      customerQuoteTable =   $('.dpib_customer_doc').DataTable( {
                data: {!! $dashboardDetails['quoteData'] !!},
                autoWidth: true,
                stateSave: false,
                stateDuration: 60 * 60 * 24,
                responsive: true,
    ...
    var reminderTable = '';
     rcolumnDefs.push({"name": "customername",  "targets": 0, "orderable": false,data: function (row, type, val, meta) {
        ...
        rcolumnDefs.push({"name": 'filename', "orderable": false, "targets": 1, data: function (row, type, val, meta) {
                            ...
                            linkString = '<a class="dpib_brokingslip_sendmail" openUrl="{!! route("mailform",["##REID"]) !!}" data-title="Send reminder"><span class="fas fa-envelope text-blue mr-right" data-toggle="tooltip" title="" data-original-title="Send email" ></span></a>';
