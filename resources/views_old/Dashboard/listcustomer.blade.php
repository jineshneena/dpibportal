...
@section('headerContent')
                    ...
                    <div class="panel-heading">
                        <ul class="panel-actions list-inline pull-right">
                            ...
                            <li><a href="{{ route('customeradd') }}"><span class="panel-action-add"  data-toggle="tooltip" title="" data-original-title="Add a customer"><span class="icon-add"></span></span></a></li>
                        </ul>
 				...
 				<form method="post"  id="dpib_customer_filter">
                                    <table class="table-filter filtersperrow4">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="4" class="panel-buttons"><button type="button" class="reset" id="filter_clear" name="filter_clear" value="filter_clear">Clear filters</button><button type="button" class="primary" id="customer_filter_submit" name="filter_submit" value="filter_submit">Apply filters</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </form>
