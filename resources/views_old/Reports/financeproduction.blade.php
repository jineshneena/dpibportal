    ...
    <div class="card-body">
        ...
        <div class="alert alert-warning alert-block" style='display:none'>
            ...
            <div class="form-group mt-5 row">
                ...
                <div class="col-4">
                    <input class="form-control" type="date" value="{{ (isset($formData['inceptionStart']) && $formData['inceptionStart'] !='' ) ? date('Y-m-d', strtotime($formData['inceptionStart'])) :date('Y-m-d') }}" id="ins_startDate" oninvalid="this.setCustomValidity('Must select a inception date range for process')" oninput="setCustomValidity('')" name='ins_startDate'>
                </div>
                <div class="col-4">
                    <input class="form-control" type="date" value="{{ (isset($formData['inceptionEnd']) && $formData['inceptionEnd'] !='' ) ? date('Y-m-d', strtotime($formData['inceptionEnd'])) :date('Y-m-d') }}" id="ins_endDate" oninvalid="this.setCustomValidity('Must select a inception date range for process')" oninput="setCustomValidity('')" name='ins_endDate' >
                </div>
                <div class="col-1">
                    <input class="form-control checkbox-custom-width" type="checkbox" value="1" id="duedatecheck" {{ (isset($formData['duedatecheck']) && $formData['duedatecheck'] !='' ) ? 'checked' :'' }} name='duedatecheck' >
                </div>
            </div>
            <div class="form-group row ui-widget">
               ...
               <div class="form-group mt-5 row">
                ...
                <div class="col-4">
                    <input class="form-control" type="date" value="{{ (isset($formData['endEnddate']) && $formData['endEnddate'] !='') ? date('d-m-Y', strtotime($formData['endEnddate'])) :date('Y-m-d') }}" id="end_startDate" name='end_startDate'>
                </div>
                <div class="col-1">
             ...
             <div class="form-group row">
                ...
                <div class="col-10">
                    ...
                    {{ Form::select('insurer', [''=>'---Select---']+ $insuranceCompanies,  isset($formData['insurer']) ? $formData['insurer'] : '' ,array('id' =>'insurer','class'=>'custom-select col-12','error-message' =>"Insurer field is mandatory" ))}}  
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    ...
                    {{ Form::select('salesperson', [''=>'---Select---']+ $salesperson,  isset($formData['salesperson']) ? $formData['salesperson'] : '' ,array('id' =>'salesperson','class'=>'custom-select col-12','error-message' =>"Insurer field is mandatory" ))}}  
                </div>
            </div>
      ...
      <div class="form-group row">
                ...
                <div class="col-10">
                    ...
                    {{ Form::select('product', [''=>'---Select---']+ $products,  isset($formData['product']) ? $formData['product'] : '' ,array('id' =>'product','class'=>'custom-select col-12','error-message' =>"Insurer field is mandatory" ))}}  
                </div>
            </div>
                 ...
                 <table class="table table-bordered table-striped dpib_policy_list color-table info-table"  style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th style="" class="nowrap">Due date</th>
...
.responsive.recalc();
    ...
    @isset($productionDetails)
                    ...
                    columnDefs.push({"name": "issuedate", "type":"date", "targets": 3, "orderable": true,data: function (row, type, val, meta) {
                            var subject =  moment(row['endorsementDuedate']).format('DD-MM-YYYY');
                            row.sortData = moment(row['endorsementDuedate']).format('DD-MM-YYYY');
                            row.displayData = subject;
...
//ALL PRODUCTION DETAILS
                    ...
                    columnDefs2.push({"name": 'validity',  "targets": 4, data: function (row, type, val, meta) {
                        ...
                        row.sortData =  (typeof(row['endorsement_number']) != "undefined" && row['endorsement_number'] !='') ? moment(row['endorsementStart']).format('DD-MM-YYYY') +'-'+moment(row['expirydate']).format('DD-MM-YYYY') : moment(row['policyStart']).format('DD-MM-YYYY') +'-'+moment(row['expirydate']).format('DD-MM-YYYY');
                        row.displayData =  (typeof(row['endorsement_number']) != "undefined" && row['endorsement_number'] !='') ? moment(row['endorsementStart']).format('DD-MM-YYYY') +'-'+moment(row['expirydate']).format('DD-MM-YYYY') : moment(row['policyStart']).format('DD-MM-YYYY') +'-'+moment(row['expirydate']).format('DD-MM-YYYY');
                    ...
                    columnDefs2.push({"name": "enddate",  "targets": 6, "orderable": true,data: function (row, type, val, meta) {
                            var subject =   (typeof(row['dueDate']) != "undefined" && row['dueDate'] !='') ? moment(row['dueDate']).format('DD-MM-YYYY'): '';
                            row.sortData = (typeof(row['dueDate']) != "undefined" && row['dueDate'] !='') ? moment(row['dueDate']).format('DD-MM-YYYY'): '';
                            row.displayData = subject;
