...
@isset($renewalDetails60)
<div class=" card">
    <div class="card-body">
        
 <a href="{{ route('renewaldaysexport')}}"><button type="button" class="btn btn-info d-none d-lg-block m-l-15 pull-right"><i class="mdi mdi-file-export"></i> Export</button></a>
