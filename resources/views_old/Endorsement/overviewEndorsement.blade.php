        ...
        <div id="content_overview" class="tabcontent col-md-12 card-body">
            <div class="row">
               ...
               <tr class="subtitle"><th colspan="2" style='padding-top:0;padding-bottom:0'>         <div class="panel-heading" style='padding-left:0;padding-bottom:0'>
                @if ((in_array('ROLE_FINANCE_MANAGER', Auth::user()->roles) || in_array('ROLE_FINANCE', Auth::user()->roles) || in_array('ROLE_OPERATION_MANAGER', Auth::user()->roles)  ||  in_array('ROLE_OPERATION_LEAD', Auth::user()->roles) || Auth::user()->id == $overviewData->added_by) && $overviewData->endorsement_status !=2)
                                                <ul class="panel-actions list-inline pull-right">
