...
<div id="details" class="clearfix" style='width:100%;height:20px;'>

<div id="invoice" >

<div class="date" style='margin-right:10px'>Date: <?php echo e(date('Y-m-d H:i')); ?></div>
...
<td class="qty">Fidelity Guarantee</td>
...
<td class="desc"><h3>TSI</h3></td>            
<td class="qty">{!! $formdata['form_tsi'] !!}</td>

</tr>
<tr>

<td class="desc"><h3>Deductible(s)</h3></td>            
<td class="qty">{!! $formdata['deductable'] !!} </td>
