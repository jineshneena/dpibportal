...
<div class="date">Date: <?php echo e(date('Y-m-d H:i:s')); ?></div>
...
<td class="qty">MARINE OPEN COVER </td>
...
<td class="desc"><h3>Declaration basis</h3></td>            
<td class="qty">{!! $formdata['declaration_basis'] !!}</td>

</tr>
<tr class='last-tr-style'>

<td class="desc"><h3>Payment basis</h3></td>            
<td class="qty">{!! $formdata['payment_basis'] !!}</td>
