...
<link type="text/css" href="{{ public_path('/css/pdf.css') }}"  rel="stylesheet" media="all"/>
</head>
<body>
...
<td class="qty">Comprehensive General Liability Policy </td>
...
<td class="desc"><h3>Occupancy</h3></td>            
<td class="qty">{!! $formdata['occupancy'] !!}</td>

</tr>

<tr>

<td class="desc"><h3>Territorial Limits</h3></td>            
<td class="qty">{!! $formdata['territorial_limit'] !!}</td>

</tr>
<tr>

<td class="desc"><h3>Applicable Law/Jurisdiction</h3></td>            
<td class="qty">{!! $formdata['applicable_law'] !!}</td>

</tr>
<tr>

<td class="desc"><h3>Limits of liability</h3></td>            
<td class="qty">{!! $formdata['liability_limit'] !!}</td>
