...
<!--                                    <li><a href="/changePassword"><i class="ti-settings"></i> Change password</a></li>-->
                            ...
                            @include('layouts.sales-navbar')
                             ...
                             @elseif(in_array('ROLE_TECHNICAL_MANAGER', Auth::user()->roles) || in_array('ROLE_TECHNICAL', Auth::user()->roles))
                                ...
                                @include('layouts.technical-navbar')
                                
                              @elseif(in_array('ROLE_OPERATION_MANAGER', Auth::user()->roles) || in_array('ROLE_OPERATION', Auth::user()->roles) || in_array('ROLE_OPERATION_LEAD', Auth::user()->roles)) 
                              
                               @include('layouts.operation-navbar') 
                    ...
                    <div class="row page-titles">
                        ...
                        <div class="col-md-12 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('dashboard')}}" style='color:#03a9f3;'>Home</a></li>
                                    <li class="breadcrumb-item middlemenu" ></li>
                                    <li class="breadcrumb-item active text-info breadcrum-last" ></i><a href="{{ route('dashboard')}}" id='breadcrumbBack' style='color:#03a9f3;text-transform: capitalize;'></a></li>
