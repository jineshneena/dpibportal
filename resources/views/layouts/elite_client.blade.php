            ...
            <header class="topbar">
                <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                    ...
                    <div class="navbar-header" >
                        <a class="navbar-brand" href="{{ route('customerdashboard') }}">
                            <!-- Logo icon --><b>
...
<!--                                <img src="{{ asset('elitedesign/assets/images/logo-icon.png') }}" alt="homepage" class="dark-logo" />-->
                            ...
                            <!-- Logo text --><span>
                                <!-- dark Logo text -->
<!--<img src="{{ asset('elitedesign/assets/images/fullcolor.png') }}" alt="homepage" class="dark-logo" />-->
                                <!-- Light Logo text -->    
                                <img src="{{ asset('elitedesign/assets/images/whitelogo.png') }}" class="light-logo" alt="homepage" style='height:60px'/></span> </a>
                    </div>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                    <!-- ============================================================== -->
                        ...
                        <ul class="navbar-nav my-lg-0">
                            ...
                            <li class="nav-item dropdown u-pro">
                                ...
                                <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                    <!-- text-->
                                    <a href="{{ route('profile',Auth::user()->customer_id) }}" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
                                    <!-- text-->
                        ...
                        <ul id="sidebarnav">
                            ...
                            <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="{{ asset('Images/avatar.jpg') }}" alt="user-img" class="img-circle"><span class="hide-menu">{{ Auth::user()->name }}</span></a>
                                <ul aria-expanded="false" class="collapse">
                                    <li><a href="{{ route('profile',Auth::user()->customer_id) }}"><i class="ti-user"></i> My Profile</a></li>                             
...
<!--                                    <li><a href="/changePassword"><i class="ti-settings"></i> Change password</a></li>-->
                              ...
                              <li> <a class="waves-effect waves-dark" href="{{ route('customerdashboard') }}" aria-expanded="false"><i class="far fa-circle text-danger"></i><span class="hide-menu">Dashboard</span></a></li>
                    ...
                    <div class="row page-titles">
                        ...
                        <div class="col-md-12 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('customerdashboard')}}" style='color:#03a9f3;'>Home</a></li>
                                    <li class="breadcrumb-item middlemenu" ></li>
                                    <li class="breadcrumb-item active text-info breadcrum-last" ></i><a href="{{ route('customerdashboard')}}" id='breadcrumbBack' style='color:#03a9f3;text-transform: capitalize;'></a></li>
...
<!--        <script src="{{ asset('js/global/jquery-ui.js') }}"></script>-->
        ...
        $(function(){
           ...
           $(document).on('click','#sidebarnav li>a:not(".has-arrow")',function(){
               ...
               localStorage.setItem("currentclicked_menu_"+{{ Auth::user()->id }},JSON.stringify({'name':$.trim($(this).text()),'url':$(this).attr('href'),'parentId':$(this).closest('ul').prev('a').text()}));
          }) 
          $(document).on('click','.breadcrumb-item',function(){
                   localStorage.removeItem("currentclicked_menu_"+{{ Auth::user()->id }});
          })
          
          
           if (localStorage.hasOwnProperty("currentclicked_menu_"+{{ Auth::user()->id }})) {
              var breadcumValues = jQuery.parseJSON(localStorage.getItem("currentclicked_menu_"+{{ Auth::user()->id }}));
