        ...
        <div class="col-md-12">
            <div class="card">
                    ...
                    <div class="insly-form">
                        ...
                        {{ Form::open(array('route' => array('updatecustomerdata', $customers->customId),'name' => 'customerForm','id'=>'customerForm') ) }}
                        @else
                        {{ Form::open(array('route' => 'savecustomer', 'name' => 'customerForm','id'=>'customerForm') ) }}
                        @endif
                                ...
                                <table class="insly-form">
                                    <tbody>
                                        ...
                                        <tr id="field_customer_idcode" class="field">
                                            ...
                                            <td><div class="element"><input type="text" id="customer_idcode" name="customer_idcode" value="{{ isset($customers->id_code) ? $customers->id_code : '' }}" autocomplete="off" maxlength="64" class="required form-control" required="required" error-message="Id code/Reg No field is mandatory"></div></td>
                                        </tr> 
                                        ...
                                        <tr id="field_customer_customercode" class="field ">
                                            ...
                                            <td>
                                                <div class="element">                                                       
                                                    <input type="text" id="customer_customercode" name="customer_customercode" value="{{ isset($customers->customer_code) ? $customers->customer_code : '' }}" autocomplete="off" maxlength="255" class='form-control'>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div class="element">
                                                    ...
                                                    @if (isset($customers->sales_person) )
                                                    @php
                                          ...
                                          <tr id="field_prop_customerprofile_10028459" class="field">
                                            ...
                                            <td><div class="element">
                                                    <input type="date" id="customer_created_date" name="customer_created_date" value="{{isset($customers->created_at) ? date('Y-m-d',strtotime($customers->created_at)) : date('Y-m-d')}}"  id="testDatepicker" class="datefield form-control" style="margin-right: 0px !important"></div>
                                            </td>
                                        </tr>
                                ...
                                <table class="insly-form">
                                    <tbody>
                                        ...
                                        <tr id="field_customergroup_oid" class="field ">
                                            ...
                                            <td>
                                                <div class="element">
                                                    {{ Form::select('customer_channel', $channelDetails, isset($customers->channel) ? $customers->channel : '' ,array('id' =>'customer_channel','style' =>'width:59%','class'=>'form-control custom-select',"error-message"=>'Channel field is mandatory'))}} 
                                            ...
                                            <td>
                                                <div class="element">
                                                    {{ Form::select('customer_technical_handler', ['' => '---Not set---']+ $technicalhanler, isset($customers->technical_handler) ? $customers->technical_handler : '' ,array('id' =>'customer_technical_handler','style' =>'width:59%','class'=>'form-control custom-select'))}} 
                                            ...
                                            <td><div class="element">
                                                    <div style="overflow: hidden">
                                                        <div style="float: left; width: 20%; padding-right: 10px"><label class="label-without-margins label-simple">Building No:</label><br>
                                                            <input type="text" id="addaddress_address_building_no" name="addaddress_address_building_no" value="{{ isset($customers->building_no) ? $customers->building_no : '' }}" autocomplete="off" style="width: 100%" maxlength="10" class='form-control'>
                                                        </div>
                                                        ...
                                                        <div style="float: left; width: 35%; padding-right: 10px"><label class="label-without-margins label-simple">District</label><br>
                                                            <input type="text" id="addaddress_address_district" name="addaddress_address_district" value="{{ isset($customers->district_name) ? $customers->district_name : '' }}" autocomplete="off" style="width: 100%" maxlength="10" class='form-control'>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div style="overflow: hidden; padding-bottom: 9px">
                                                        <div style="float: left; width: 20%; padding-right: 10px"><label class="label-without-margins label-simple">City</label><br>
                                                            <input type="text" id="addaddress_address_city" name="addaddress_address_city" value="{{ isset($customers->city_name) ? $customers->city_name : '' }}" autocomplete="off" style="width: 100%" maxlength="10" class='form-control'>
                                                        </div>
                                                        ...
                                                        <div style="float: left; width: 35%; padding-right: 10px"><label class="label-without-margins label-simple">Additional No:</label><br>
                                                            <input type="text" id="addaddress_address_additional_no" name="addaddress_address_additional_no" value="{{ isset($customers->additional_no) ? $customers->additional_no : '' }}" autocomplete="off" style="width: 100%" maxlength="10" class='form-control'>
                                                        </div>
                                                    </div>
                                                    <div style="overflow: hidden; padding-bottom: 9px">
                                                        <div style="float: left; width: 20%; padding-right: 10px"><label class="label-without-margins label-simple">Unit No:</label><br>
                                                            <input type="text" id="addaddress_address_unit_no" name="addaddress_address_unit_no" value="{{ isset($customers->unit_no) ? $customers->unit_no : '' }}" autocomplete="off" style="width: 100%" maxlength="10" class='form-control'>
                                                        </div>
...
<script src="{{ asset('elitedesign/dist/js/pages/jasny-bootstrap.js') }}"></script>
