...
<div class="row">
   @section('headtitle')
Customer <i class="fas fa-angle-double-right"></i><span class='text-blue' style='font-size:25px'> @if(!empty($customers->customerName)) {{$customers->customerName}} @endif</span>
@endsection
    ...
    <div class="col-md-12 card" >
        ...
        <li id="tab_timeline" class="nav-item" onclick="TAB.select('timeline', '{{route('customertimeline',[$customers->customId,date('Y')])}}', 0)"> <a class="nav-link {{ empty($overviewTab) || $overviewTab == 'timeline' ? 'active' : '' }}" data-toggle="tab" href="#content_timeline" role="tab" aria-selected="false"><span class="hidden-sm-up"><i class="fa fa-th-list"></i></span> <span class="hidden-xs-down">Timeline</span></a> </li>
        <li id="tab_users" class="nav-item" onclick="TAB.select('users', null, 0)"> <a class="nav-link {{ empty($overviewTab) || $overviewTab == 'users' ? 'active' : '' }}" data-toggle="tab" href="#content_users" role="tab" aria-selected="false"><span class="hidden-sm-up"><i class="fas fa-users"></i></span> <span class="hidden-xs-down">Active users</span></a> </li>
...
<div class="row card">
        ...
        <div id="content_overview" class="tabcontent col-md-12 card-body  ribbon-wrapper-reverse card" >
            ...
            <ul class="panel-actions list-inline pull-right">
                ...
                <li ><a href="{{ route('editcustomer',$customers->customId)}}"><button type="button" class="btn btn-success btn-rounded"><i class="fas fa-edit"></i> Edit</button></a></li>
                 <li ><a href="{{ route('newrequest',$customers->customId)}}"><button type="button" class="btn btn-success btn-rounded"><i class="fas fa-plus"><div class="notify" > <span class="heartbit" style='top:-16px;'></span> <span class="point" style='top:-4px;'></span> </div></i>Add request</button></a></li>
...
<!--                <li><div class="btn-group"><button type="button"><span class="icon-settings"></span><span class="icon-arrow-down"></span><span class="icon-active"></span></button>
            ...
            <div id="customer_overview" class="panel-collapse panel-body">
                ...
                <table class="info-table">
                    <tbody>
                        <tr><td style='width:55%'>Customer type:</td><td>{{ ($customers->type ==1) ? 'Company' : 'Individual' }}</td></tr>
                        ...
                        <tr><td>Account manager:</td><td><span class="person-popover" data-toggle="popover" data-title="Dbroker company" data-content="{{$customers->accountManager}}" data-original-title="" title="">{{$customers->accountManager}}</span></td></tr>
                        <tr><td>Sale person:</td><td><span class="person-popover" data-toggle="popover" data-title="Dbroker company" data-content="{{$customers->saleperson}}" data-original-title="" title="">{{$customers->saleperson}}</span></td></tr>
            ...
            <table class="table table-bordered table-striped table-hovered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="nowrap iconactions"><a  class="dpib_connect_customers_edit" data-url="{{route('editconnectiondetailsform',[$customers->customId, $relationdetails->mainId])}}"><span class="fas fa-edit text-blue mr-right" data-toggle="tooltip" title="" data-original-title="Edit a connection details"></span></a><a class="dpib_deletecustomerconnection" data-url="{{route('deletecustomerconnection',[$customers->customId,$relationdetails->mainId])}}"><span class="fas fa-archive text-blue" data-toggle="tooltip" title="" data-original-title="Delete customer connection"></span></a></td>
                    </tr>
                     @endforeach
...
<div id="add_note_template_2" style="display:none;">
    ...
    <div id="content_policy" class="tabcontent col-12" rel="{{route('policylisting', $customers->customId)}}" style="display:none">
       ...
       <div id="content_timeline" class="tabcontent col-12"  style="display:none;" rel="{{route('customertimeline',[$customers->customId,date('Y')])}}">
