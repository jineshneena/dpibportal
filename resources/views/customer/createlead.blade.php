...
<!--                                                    <div class="custom-control custom-radio">
        ...
        <tr id="field_customer_channel" class="field ">
                                            ...
                                            <td>
                                                <div class="element">
                                                    {{ Form::select('customer_channel', $channelDetails, '',array('id' =>'customer_channel','class'=>'form-control custom-select required','error-message' =>"Channel field is mandatory"))}} 
                                ...
                                <table class="insly-form">
                                    <tbody>
                                        <tr id="field_customer_email" class="field"><td class=""><div class="label"><span class="text-danger icon-asterix"></span><span class="title">E-mail address</span></div></td><td><div class="element">
                                                    ...
                                                    <input type="text" id="customer_mobile" name="customer_mobile" value="{{ isset($customers->mobile) ? $customers->mobile : '' }}" autocomplete="off" maxlength="255" required class="required form-control" error-message="Customer mobile is mandatory"></div></td></tr>  
                ...
                <td><div class="element">
                        {{ Form::select('customer_id',  array('' => '--- not entered ---')+$customerDetails, '',array('name'=>'related_customer_id','id' =>'related_customer_id','class'=>'form-control custom-select','error-message' =>"Insurance company field is mandatory"))}}
                    </div>
                </td>
            </tr>   
