...
@section('content')
  ...
  <div class="row col-12 dpib-custom-form">
         ...
         @section('headtitle')
         <a href='{{ route('customeroverview',$selectedcustomer->id)}}'>{{$selectedcustomer->name}}</a> <i class="fas fa-angle-double-right"></i><span class='text-blue' style='font-size:25px'> New request </span>
@endsection
            ...
            <tr id="field_customer_gender" class="field customertype" >
                                            ...
                                            <td>
                                                <div class="element">
                                                    ...
                                                    @if (isset($selectedcustomer->sales_person) )
                                                    @php
