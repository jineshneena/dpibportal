...
<div class="row col-12 dpib-custom-form">
    ...
    @section('headtitle')
    @if($selectedcustomer)
    <a href='{{ route('customeroverview',$selectedcustomer->id)}}'>{{$selectedcustomer->name}}</a>

    <i class="fas fa-angle-double-right"></i>@endif<span class='text-blue' style='font-size:25px'>
        New request </span>
    @endsection
                            ...
                            <table class="insly-form">
                                <tbody>
                                    <tr id="field_addperson_name" class="field">
                                        ...
                                        <td>
                                            <div class="element">
                                                {{ Form::select('customer_select',[''=>'---- select customer ----'] + $customerDetails, isset($requestDetails->customer_id) ? $requestDetails->customer_id:$customerId,array('id' =>'customer_select','style'=>'width: 100%;','class'=>"autocomplete required form-control custom-select","required" =>"required" ,"error-message"=>'Customer selection is mandatory'))}}                                                    
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr id="field_addperson_name" class="field">
                                        ...
                                        <td>
                                            <div class="element">
                                                ...
                                                {{ Form::select('crm_type', array(''=>'---Not set---',1 => 'New sale',3=>'Renewal'),isset($requestDetails->type) ? $requestDetails->type:"1",$fieldArray)}}
                                    ...
                                    <tr id="field_dib_old_policies" class="field dib_old_policies">
                                        ...
                                        <td>
                                            <div class="element" >
                                                {{ Form::select('activePolicyList', ['' =>'----Not Select----'], '',array('id' =>'activePolicyList','style'=>'width: 100%;','class'=>'request_lineof_business required form-control custom-select','error-message' =>"Line of business field is mandatory" ))}}
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr id="field_request_description" class="field dib_request">
                                        ...
                                        <td>
                                            <div class="element">
                                                <textarea class="note_add_entry full-width form-control" name="request_description" rows="10" wrap="soft" >{{isset($requestDetails->description) ? $requestDetails->description:''}}</textarea>
                                            </div>
                                        </td>
                                    </tr>
