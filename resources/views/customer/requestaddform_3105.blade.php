                            ...
                            <table class="insly-form">
                                <tbody>
                                    ...
                                    <tr id="field_dib_old_policies" class="field dib_old_policies">
                                        ...
                                        <td>
                                            <div class="element" >
                                                {{ Form::select('activePolicyList', ['' =>'----Not Select----'], '',array('id' =>'activePolicyList','style'=>'width: 100%;','class'=>'request_lineof_business required form-control custom-select','error-message' =>"Policy field is mandatory" ))}}
                                            </div>
                                        </td>
                                    </tr>
